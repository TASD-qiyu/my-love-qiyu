        ...
        months.forEach(mo => {
            ...
            if (entries.length === 0) {
                ...
                entries.forEach(e => {
                    ...
                    let initiatorLabel, initiatorClass;
if (e.initiator === 'partner') {
    initiatorLabel = partnerName + '邀请';
    initiatorClass = '';
} else if (e.initiator === 'missed') {
    initiatorLabel = '我错过了';
    initiatorClass = 'cd-init-missed';
} else {
    initiatorLabel = userName + '邀请';
    initiatorClass = 'cd-init-user';
}
